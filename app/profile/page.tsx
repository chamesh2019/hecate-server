...
import { FiKey, FiPlus, FiX } from 'react-icons/fi';
            ...
            <div className="max-w-2xl mx-auto">
                <header className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center space-x-2">
                        <button className="flex items-center space-x-2 px-3 py-1 bg-gray-800 rounded-md text-sm"><FiKey /><span>Your api key</span></button>
                        <button onClick={() => setShowModal(true)} className="flex items-center space-x-2 px-3 py-1 bg-gray-800 rounded-md text-sm"><FiPlus /><span>New secret</span></button>
                    </div>
                </header>
